...
class Topex:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('Topex', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/topex_plugin/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u''),
            callback=self.run,
